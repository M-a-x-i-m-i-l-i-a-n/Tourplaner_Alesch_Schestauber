...
public class TourImportExport {
    ...
    public Tour importFile(File file){
        try {
            ...
            //(String name, String description, String start, String destin, String type, String time, String lrlng, Double distance,  String lrlat, String ullng, String ullat, String sessionID, String url)
